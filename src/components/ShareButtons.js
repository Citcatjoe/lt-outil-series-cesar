  ...
  render() {
    ...
    return <li className="share-buttons">
        ...
        <span className="col2">
          ...
          <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/intent/tweet?text=Pour%20se%20délasser%20ou%20pour%20frissoner,%20pour%20découvrir%20ou%20simplement%20pour%20en%20parler,%20Le%20Temps%20vous%20propose%20sa%20sélection%20de%20séries%20TV%20http://labs.letemps.ch/interactive/2018/_sandbox/gus/%20&via=letemps">
            <button className="share-buttons--button">
              {Parser(
