  ...
  render() {
    ...
    return <li className="share-buttons">
        ...
        <span className="col2">
          ...
          <a target="_blank" rel="noopener noreferrer" href={"https://twitter.com/intent/tweet?text=" + description + "%20" + url + "%20&via=letemps"}>
            <button className="share-buttons--button">
              {Parser(
          ...
          <a target="_blank" rel="noopener noreferrer" href={"https://www.linkedin.com/shareArticle?url=" + url + "&mini=true&title=" + title + "&summary=" + description + "&source=Le%20Temps"}>
            <button className="share-buttons--button">
              {Parser(
